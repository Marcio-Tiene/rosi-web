  ...
  return (
    <SectionRosiHistory>
      ...
      <WhoIAmContentWrapper>
        ...
        <WhoIAmArticle>
          <WhoIAmPatagraph>
            &emsp;&nbsp; Mentora de carreira, especialista em liderança e gestão de pessoas,&nbsp;
            Rosi Job é conhecida por sua carreira meteórica e seus resultados expressivos com
            equipes. <br />
            &emsp;&nbsp; Sua especialidade é liderança com foco em gestão de pessoas, pois ela
            acredita que os resultados são 100% gerados por elas. Pós graduada em gestão de pessoas,
            formada em administração e coaching.
            <br />
            ...
            do cargo até a decisão de sair e seguir para o empreendedorismo. &nbsp; Ela é coautora
